    ...
    head: {
      meta: [
        ...
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        {
          name: 'keywords',
          content:
            'kumanote, Software freelancer, Software development, web3 development',
        },
        {
          property: 'og:site_name',
          content: 'Kumanote LLC.',
        },
        { property: 'og:type', content: 'website' },
        { property: 'og:url', content: 'https://kumano-te.com' },
        {
          property: 'og:image',
          content: 'https://kumano-te.com/images/ogp/common.png',
        },
