...
<template>
  <section class="relative bg-gray-50 dark:bg-gray-900 py-16 sm:py-24 lg:py-32">
    <div class="relative">
      <div
      ...
      >
        ...
        <p
          class="mt-5 mx-auto max-w-prose text-xl text-gray-500 dark:text-gray-400"
        >
          <TextsTextContainer :text="$t('blog_description')" />
        </p>
      </div>
      <div
